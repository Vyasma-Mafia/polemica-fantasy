  ...
  return (
    <div className="pf-page">
      ...
      <article className="pf-prose">
        ...
        <h2>Дедлайн</h2>
        <p>Изменить состав можно до момента дедлайна серии («Доступно до» на экране выбора серии). После дедлайна команда фиксируется для расчёта очков.</p>

        <h2>Очки</h2>
        <p>Итог команды складывается из очков по каждой карточке за игры серии: базовые очки игрока плюс бонусы за достижения, заданные на карточке.</p>
