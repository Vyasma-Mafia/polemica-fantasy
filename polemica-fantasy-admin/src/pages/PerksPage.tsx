...
import { listPerks, updatePerk } from '../api/perks'
import type { PerkAdminDto, OccurrenceType } from '../api/types'
...
export function PerksPage() {
  ...
  const [editRow, setEditRow] = useState<PerkAdminDto | null>(null)
  ...
  const mut = useMutation({
    mutationFn: ({
      ...
      id: string
      body: Parameters<typeof updatePerk>[1]
    }) => updatePerk(id, body),
    onSuccess: () => {
  ...
  return (
    <div>
      <Typography.Title level={3}>Perks</Typography.Title>
