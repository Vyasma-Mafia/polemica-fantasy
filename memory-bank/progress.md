...
- [x] Card-aware lineup correction: BUDGET for series 273 verified at 100/175; strategy v8 applies rarity modifiers and expected bonuses for the exact card perks, with selected non-`ninja` perk-rate evidence remaining COMPLETE. Full runtime suite passes 166 tests.
