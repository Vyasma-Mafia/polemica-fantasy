...
- [x] Проверки: Python 3.10 runtime `104 passed`; backend focused compile/unit green; изолированный remote Testcontainers прогон Bearer + pack idempotency/concurrency на PostgreSQL 16 green с Docker API 1.44.
