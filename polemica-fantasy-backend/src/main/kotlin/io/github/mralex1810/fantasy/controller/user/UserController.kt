...
class UserController(
    ...
    fun myCards(
        ...
        @RequestParam(required = false) achievementIds: List<String>?,
    ): List<UserCardItemDto> = userCardCollectionService.listCards(user, tournamentId, seriesId, rarity, achievementIds)
